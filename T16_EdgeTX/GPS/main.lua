...
local function update(wgt, options)
	...
	lcd.setColor(COLOR_THEME_PRIMARY1, wgt.options.TextColor)
	lcd.setColor(COLOR_THEME_SECONDARY1, wgt.options.LineColor)
...
function refresh(wgt, event, touchState)
	...
	--line horz.
	--lcd.drawLine(wgt.zone.x + 0, wgt.zone.y + 25, wgt.zone.x + 224, wgt.zone.y + 25, SOLID, COLOR_THEME_SECONDARY1)
	...
	--lcd.drawLine(wgt.zone.x + 74, wgt.zone.y + 25, wgt.zone.x + 74, wgt.zone.y + 85, SOLID, COLOR_THEME_SECONDARY1)	
	...
	--lcd.drawLine(wgt.zone.x + 150, wgt.zone.y + 25, wgt.zone.x + 150, wgt.zone.y + 85, SOLID, COLOR_THEME_SECONDARY1)	
	...
	--line horz.
	lcd.drawLine(wgt.zone.x + 0, wgt.zone.y + 85, wgt.zone.x + 224, wgt.zone.y + 85, SOLID, COLOR_THEME_SECONDARY1)
	...
	--line horz.
	lcd.drawLine(wgt.zone.x + 0, wgt.zone.y + 145, wgt.zone.x + 224, wgt.zone.y + 145, SOLID, COLOR_THEME_SECONDARY1)
